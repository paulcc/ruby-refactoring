...
>          $$ nest 3 (   vcat [ text d <> char ';' | d <- vars ]
>                     $$ pp mthds)
>	   $$ char '}'
>	   where
...
>	pp (MethodDecl name args decls body retval)
>	 = text "public" <+> text name <+> text (unwords args)
>	   <+> char '{'
>          $$ nest 3 (   vcat [ text d <> char ';' | d <- decls ]
>                     $$ pp body
